package pl.edu.pjwstk.todoapp.aspect;
...
public class LogicAspect {
    ...
    @Pointcut("execution(public * pl.edu.pjwstk.todoapp.logic.ProjectService.createGroup(..))")
    ...
    public Object aroundProjectCreateGroup(ProceedingJoinPoint jp) {
